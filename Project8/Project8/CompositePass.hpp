...
public:
    ...
    void Calcurate(Mat& inout, CompositePassInput input) override
    {
        ...
        Mat scaledConvertedImg = Mat(resultImgSize.y / (size(StarData::latIndexToLat) - 1), resultImgSize.x / StarData::latToLonImgCount.at(centerLat), CV_8UC3);
        ...
        int sourceIndex = starImg.sourceIndex();
