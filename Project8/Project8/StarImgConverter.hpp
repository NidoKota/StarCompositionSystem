...
namespace StarCompositionSystem
{
    ...
    private:
        ...
        void ConvertInternal(Mat& result, SideStarImg& sideStarImg, Mat& img, size_t starImgsSize, optional<string> endPassName = nullopt)
        {
            ...
            try
            {
                ...
                bool isRemoved = _removeIndex0ImgPass.Calcurate(img, { starImg, starImgsSize });
                    ...
                    thread([=, &result, &imgs, &starImgs]
                        {
                            ...
                            ConvertInternal(result, sideStarImg, imgs[sourceIndex], starImgs.size());
    ...
    public:
        ...
        void SingleConvert(Mat& result, vector<StarImg>& starImgs, size_t sourceIndex, optional<string> endPassName = nullopt)
        {
            ...
            _isRunning = true;
            {
                ...
                GetSideStarImg(sideStarImg, starImgs, sourceIndex);
                ConvertInternal(tmp, sideStarImg, result, starImgs.size(), endPassName);
            }
            _isRunning = false;
        }
